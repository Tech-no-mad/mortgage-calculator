...
description: "Current FHA loan limits for LA County, CA. Single-family limit is $1,149,825. Calculate your FHA payment with real LA property tax rates."
date: "2026-07-07"
canonicalUrl: "/blog/fha-loan-limits-los-angeles-county-california/"
state: "california"
county: "los-angeles-county"
loanType: "fha"
relatedCalculator: "/fha-loans/"
---

The Federal Housing Administration (FHA) sets specific maximum borrowing limits for every county in the United States, and Los Angeles County, California is no exception. If you are looking to buy a home in Los Angeles or the surrounding areas using an FHA loan in 2026, understanding these limits is the first crucial step in your homebuying journey.
...
*   **1-Unit (Single-Family):** $1,149,825
*   **2-Unit (Duplex):** Higher limits apply
*   **3-Unit (Triplex):** Higher limits apply
*   **4-Unit (Fourplex):** Higher limits apply

These numbers represent a significant increase from previous years, reflecting the rising property values across the Los Angeles metro area. 

### Why the FHA Limit Matters

FHA loans are incredibly popular because they require a down payment as low as 3.5% and have much more forgiving credit score requirements. However, you cannot borrow a single dollar over the $1,149,825 limit for a single-family home. 
...
**2. Property Taxes:** This is the hidden trap. The average effective property tax rate in this county is approximately **1.20%**. 
